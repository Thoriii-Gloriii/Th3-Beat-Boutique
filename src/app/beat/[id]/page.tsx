...
export default function BeatPage({ params }: { params: { id: string } }) {
  const mockStems = [
    { name: 'Drums', color: '#FF0000', src: '/mock-drums.mp3' },
    { name: 'Bass/808', color: '#590000', src: '/mock-bass.mp3' },
    { name: 'Melody', color: '#d10000', src: '/mock-melody.mp3' },
    { name: 'FX', color: '#ffb3b3', src: '/mock-fx.mp3' },
  ];
  ...
  return (
    <div className="p-4 flex flex-col gap-6 w-full max-w-2xl mx-auto pb-24">
      ...
      <div className="mt-4 flex flex-col gap-4">
        ...
        <InteractiveStemPlayer stems={mockStems} />
        ...
        <VocalBoothRecorder beatTitle="Midnight City" />
      </div>
    </div>
  );
}
